...
import { EntityBlockRectangle, EntityBlockRadiusedRectangle } from '../../../svg/blocks'
import { EntityBlock } from '../../../types/DiagramEntityTypes/EntityPart'

export class BlockSchemeTerminal extends Entity {
  constructor(x: number, y: number, width: number, height: number) {
    super(EntityType.BlockSchemeAction ,x, y, width, height)

    this.parts = [
      new EntityPart((entity: Entity) => new EntityBlock(
        0, 0, entity.width, entity.height, EntityBlockRadiusedRectangle
      ), true, 'Terminal')
    ]
